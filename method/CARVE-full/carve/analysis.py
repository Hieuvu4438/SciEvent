"""Error analysis for a CARVE prediction file.
...
from carve.data import EXCLUDED_FROM_SCORING, default_data_dir
...
def analyse_errors(pred_path, gold_path):
