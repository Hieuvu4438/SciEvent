"""Data loading and label construction for SciEvent-Next.
...
def default_data_dir():
    ...
    return os.path.join(root, "third_party", "SciEvent", "SciEvent_data", "ONEIE", "all_splits")


def load_split(split, data_dir=None):
    data_dir = data_dir or default_data_dir()
    path = os.path.join(data_dir, f"{split}.oneie.json")
    windows = []
