...
[github.com/Hieuvu4438/CLAVE](https://github.com/Hieuvu4438/CLAVE), which ships **CLAVE** (*Cross-Fitted Clause-Level Argument Verification for Scientific Event Extraction*): the CARVE-simple proposer plus the HONE verifier.
...
|---|---|---|
| [`method/HONE`](method/HONE) | **HONE**: propose-then-verify with an out-of-fold cross-encoder verifier. Includes the development of the released **CLAVE** (CARVE-simple + HONE) | archived development record of the final method |
| [`method/CARVE-full`](method/CARVE-full) | **CARVE**, original release: two BIO heads, event-type conditioning and a calibrated threshold, with its single-factor ablations | superseded; previous content of the repository now named CLAVE |
...
| **CLAVE = CARVE-simple + HONE (released)** | 1 | **77.82** | **60.09** | **52.36** |
